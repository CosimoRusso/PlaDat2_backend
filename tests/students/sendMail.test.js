...
test("Send an email - API version", async function (){
  ...
  const response = await r2.post(url,{json:{message: "Message Test", subject: "Subject Test", companyEmail: "cosimo.russo123@gmail.com"},headers: {authorization: "Bearer " + jwt}}).response;
